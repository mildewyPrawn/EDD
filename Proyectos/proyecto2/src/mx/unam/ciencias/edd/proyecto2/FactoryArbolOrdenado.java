...
public class FactoryArbolOrdenado{
    
    /**Cadena del codigo xml para las imágenes .svg*/
    private String s;

    /**ArbolBinarioOrdenado en donde se guardaran los datos*/
    private ArbolBinarioOrdenado<Integer> datos;
    
    /**
     * Constructor de la fabrica de arboles ordenados.
     * @param Lista de enteros, son los datos a agregar.
     * @param inicio del codigo xml.
     */
    public FactoryArbolOrdenado(Lista<Integer> datos, String s){
	this.datos = new ArbolBinarioOrdenado<Integer>(datos);
	this.s = s;
    }
