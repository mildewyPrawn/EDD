...
public class FactoryMonticulo{
    
    /**Cadena del codigo xml para las imágenes .svg*/
    private String s;

    /**ArbolBinarioCompleto en donde se guardaran los datos*/
    private ArbolBinarioCompleto<Integer> datos;
    
    /**
     * Constructor de la fabrica de monticulos minimos.
     * @param Lista de enteros, son los datos a agregar.
     * @param inicio del codigo xml.
     */
    public FactoryMonticulo(Lista<Integer> datos, String s){
	datos = MonticuloMinimo.heapSort(datos);
	this.datos = new ArbolBinarioCompleto<Integer>(datos);
	this.s = s;
    }
